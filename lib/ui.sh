...
display_maintenance_menu() {
    ...
    echo ""
    echo -e "  ${INFO}[1]${NC} ${SPINNER}🔄${NC}  ${TEXT}Refresh All Configurations${NC}"
    echo -e "  ${INFO}[2]${NC} ${SPINNER}📦${NC}  ${TEXT}Update Packages (Brewfile)${NC}"
    echo -e "  ${INFO}[3]${NC} ${SPINNER}🔧${NC}  ${TEXT}Reconfigure Individual Modules${NC}"
    echo -e "  ${INFO}[4]${NC} ${SPINNER}🗑️${NC}   ${TEXT}Remove Module${NC}"
    echo -e "  ${INFO}[5]${NC} ${SPINNER}📊${NC}  ${TEXT}View Installation Status${NC}"
    echo -e "  ${INFO}[6]${NC} ${SPINNER}📝${NC}  ${TEXT}View Logs${NC}"
    echo -e "  ${INFO}[7]${NC} ${ERROR}❌${NC}  ${TEXT}Exit${NC}"
    echo ""
